...
def main():
    ...
    ## save data
    np.save(f"D:/nyc_taxi/data-3d/train.npy", train_data)
    np.save(f"D:/nyc_taxi/data-3d/test.npy", test_data)
    np.save(f"D:/nyc_taxi/data-3d/val.npy", val_data)

    ## save masks
    for key in masks.keys():
        np.save(f"D:/nyc_taxi/data-3d/{key}_mask.npy", masks[key])
